    ...
    .then(async foundUser=>{
       let match 
        ...
        if(!foundUser || !match){
            ...
            return doneCallback(null, foundUser) //send he found user objects aka their specs
        }
    })
    .catch(err=>doneCallback(err)) // donecallBack takes two parameters: error, userToBeLoggedIn
}
